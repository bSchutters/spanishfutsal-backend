...
export interface ApiJoueurJoueur extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    capitaine: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLffsUpdateLffsUpdate extends Struct.CollectionTypeSchema {
  collectionName: 'lffs_updates';
  info: {
    description: 'Infos sur les derni\u00E8res mises \u00E0 jour';
    displayName: 'LFFS Update';
    pluralName: 'lffs-updates';
    singularName: 'lffs-update';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::match.match'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    replay_link: Schema.Attribute.String;
    score_away: Schema.Attribute.Integer;
    score_home: Schema.Attribute.Integer;
    season: Schema.Attribute.Relation<'manyToOne', 'api::season.season'>;
    serie_reference: Schema.Attribute.String;
...
export interface ApiRankingRanking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    goal_difference: Schema.Attribute.Integer;
    goals_against: Schema.Attribute.Integer;
    goals_for: Schema.Attribute.Integer;
    imported_at: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ranking.ranking'
    ...
    positionChange: Schema.Attribute.Enumeration<['no_change', 'up', 'down']> &
      Schema.Attribute.DefaultTo<'no_change'>;
    publishedAt: Schema.Attribute.DateTime;
    result_sequence: Schema.Attribute.String;
    season: Schema.Attribute.Relation<'manyToOne', 'api::season.season'>;
...
export interface ApiSeasonSeason extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    matchs: Schema.Attribute.Relation<'oneToMany', 'api::match.match'>;
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imports: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::setting.setting'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::lffs-update.lffs-update': ApiLffsUpdateLffsUpdate;
